...
public class GeneralTipsofDiabetes extends AppCompatActivity {
    ...
    private ArrayList<Item> generateData(){
        ...
        items.add(new Item("Add Starch","Avoid excess or low starch vegetables e.g.carrots,beans," +
                "gourds,green chillies,capsicums,tomatoes,radish,asparagus,cauliflower,broccoli etc and" +
                " strictly avoid potatoes,yam,colocasia or other starchy items(food items with low glycaemic index)"));
        ...
        items.add(new Item("Things to avoid By Diabetes Patients","Tobacco,Smoking,Avoid Canned food," +
